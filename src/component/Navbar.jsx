    ...
    <div className="px-4 py-2 relative bg-slate-800 lg:bg-white ">
      {close ? (
        <svg
          ...
          onClick={menuHandle}
          className="inline w-8 h-8 text-white absolute top-3 right-36 z-10 lg:hidden"
          fill="none"
          viewBox="0 0 24 24"
          stroke="black"
        >
      ...
      <div className={`${menuIcon} lg:block`}>
        <aside className="fixed inset-y-0 left-0 bg-white shadow-lg max-h-screen w-[18rem] md:w-[13rem]">
          <div className="flex flex-col justify-between h-full">
            <div className="flex-grow">
              <div className="px-4 py-8 text-center border-b-2 ">
                ...
                <h1 className="text-xl font-bold leading-none">
                  ...
                  <h5 className="text-sm">name@gmail.com</h5>
                </h1>
              </div>
              <div className="p-4 ">
            ...
            <div className="p-4 flex items-center justify-center cursor-pointer hover:bg-blue-300 duration-700">
              <img
                className="w-6"
